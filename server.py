    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return ["You are in the room with the white wallpaper.",
                ...
                "You are in the room with the beige wallpaper.",
               ][room_number]
    ...
    def move(self, arguement):
        ...
        * "west"
        ...
        if self.room == 0 and arguement == "north":
            self.room = 3

        if self.room == 0 and arguement == "west":
            self.room = 1

        if self.room == 0 and arguement == "east":
            self.room = 2

        if self.room == 1 and arguement == "east":
            self.room = 0

        if self.room == 2 and arguement == "west":
            self.room = 0

        if self.room == 3 and arguement == "south":
            self.room = 0
